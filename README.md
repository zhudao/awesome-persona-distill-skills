<div align="center">
    <img src="media/header.svg" alt="抽象化的角色网络与记忆连线插图。" width="900">
...
[Bloome](https://bloome.im/agent/join/l7BU8Y4m?ref=lS4ObZC6&from=poster) 让你跳过本地安装和配置：把列表里的任意一个 skill 作为 agent 一键加进聊天，直接对话试用。喜欢就分享给别人，或拉进群一起玩，零配置。想挨个体验这个列表里的 skill，在 Bloome 上最快。
